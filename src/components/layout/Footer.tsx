        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <Link href="/menu" className="block text-black hover:text-accent-gold transition-colors">
                메뉴 보기
              </Link>
              <Link href="/contact" className="block text-black hover:text-accent-gold transition-colors">
                창업 문의
              </Link>
              <Link href="/store" className="block text-black hover:text-accent-gold transition-colors">
                매장 찾기
              </Link>
              <Link href="/news" className="block text-black hover:text-accent-gold transition-colors">
                이벤트 & 소식
              </Link>
              <Link href="/contact" className="block text-black hover:text-accent-gold transition-colors">
                고객센터
